...
public class ScriptedTestingPasswordTCValidationChallengePage extends BasePage {
    ...
    //number division input methods (for challenge 9) (invalid tc validation - non-allowed symbols)
    public void inputPasswordTCValidationChallenge9(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(passwordInputField));
    ...
    //number division input methods (for challenge 11) (invalid tc validation - doesn't meet requirements)
    public void inputPasswordTCValidationChallenge11(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(passwordInputField));
        passwordInputField.sendKeys("P@ssw_rd");
    }
