...
public class LearnModeUpdateProfilePage extends BasePage{
    ...
    //update profile input methods (for challenge 3) (inputs longer than max length)
    public void inputUpdateProfileChallenge3Nickname3(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(nicknameInputField));
        nicknameInputField.sendKeys("longnick9_");
    }
    public void inputUpdateProfileChallenge3FirstName3(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(firstNameInputField));
        firstNameInputField.sendKeys("MaximilianaElizabethMontgomery");
    }
    public void inputUpdateProfileChallenge3LastName3(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(lastNameInputField));
    ...
    //update profile input methods (for challenge 5) (non-allowed characters inputs)
    public void inputUpdateProfileChallenge5Nickname5(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(nicknameInputField));
        nicknameInputField.sendKeys("123-AA");
    }
    public void inputUpdateProfileChallenge5FirstName5(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(firstNameInputField));
        firstNameInputField.sendKeys("X Æ A-12");
    }
    public void inputUpdateProfileChallenge5LastName5(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(lastNameInputField));
        lastNameInputField.sendKeys("X Æ A-12");
    }
    //update profile input methods (for challenge 6) (non-allowed characters inputs)
    public void inputUpdateProfileChallenge6Nickname6(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(nicknameInputField));
        nicknameInputField.sendKeys("@@@@@");
    }
    public void inputUpdateProfileChallenge6FirstName6(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(firstNameInputField));
        firstNameInputField.sendKeys("Christopher");
    }
    public void inputUpdateProfileChallenge6LastName6(){
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(450));
        wait.until(ExpectedConditions.visibilityOf(lastNameInputField));
