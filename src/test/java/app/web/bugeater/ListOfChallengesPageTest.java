...
public class ListOfChallengesPageTest extends TestMethods{
    ...
    void exploratoryTestingRestorePasswordTCValidationChallengeTest(){
        ...
        //restore password test case validation challenge 6 (invalid tc validation - uppercase only password)
        ...
        //restore password test case validation challenge 9 (invalid tc validation - non-allowed symbols password)
